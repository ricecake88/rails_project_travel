...
@san_diego_1 = Attraction.create(:name => "Seaworld", :admission => "", :webpage => "", :destination_id => "")
@san_diego_1 = Attraction.create(:name => "San Diego Zoo", :admission => "", :webpage => "", :destination_id => "")
...
@banff_1 = Attraction.create(:name => "Lake Louise", :admission => "Free", :webpage => "Lake Louise URL", :destination_id => @banff.id)
 ...
 @tokyo_1 = Attraction.create(:name => "", :admission => "", :webpage => "", :destination_id => @tokyo.id)
 @tokyo_2 = Attraction.create(:name => "", :admission => "", :webpage => "", :destination_id => @tokyo.id)

 @seoul = Destination.create(:city_name => "Seoul", :country_name => "Korea", )
 @seoul_1 = Attraction.create(:name => "", :admission => "", :webpage => "", :destination_id => @seoul.id)
 @seoul_2 = Attraction.create(:name => "", :admission => "", :webpage => "", :destination_id => @seoul.id)
