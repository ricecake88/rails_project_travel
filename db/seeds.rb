...
@seattle_1 = Attraction.create(:name => "Space Needle", :admission => "$10", :webpage => "Space Needle URL", :destination_id => @seattle.id)
@seattle_2 = Attraction.create(:name => "Chihuly Museum", :admission => "$24", :webpage => "Chihuly Museum URL", :destination_id => @seattle.id)
