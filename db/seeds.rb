...
@user_v1_l1_item1 = ItineraryItem.create(:leg_id => @user1_vacation1_leg1.id, :day_of_trip => 1,
    :type_of_activity => "Activity", :attraction_id => @seattle_1.id, :activity_order => 1)
@user_v1_l1_item2 = ItineraryItem.create(:leg_id => @user1_vacation1_leg1.id, :day_of_trip => 2,
    :type_of_activity => "Activity", :attraction_id => @seattle_2.id, :activity_order => 1)
@user_v1_l2_item1 = ItineraryItem.create(:leg_id => @user1_vacation1_leg2.id, :day_of_trip => 3,
    :type_of_activity => "Activity", :attraction_id => @banff_1.id, :activity_order => 1)

@user_v2_l1_item1 = ItineraryItem.create(:leg_id => @user1_vacation2_leg1.id, :day_of_trip => 1,
