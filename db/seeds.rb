...
@user1 = User.create(:name => "Grace", :place_id => @sandiego.id)
...
@user1_vacation2_leg1 = Leg.create(:vacation_id => @user1_vacation2.id, :arrival_place_id => @seattle.id, :departure_place_id => @sandiego.id)
